...
open class AudioVisualizationView: UIView {
    ...
    internal var meteringLevelBarWidth: CGFloat = 1 {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    internal var meteringLevelBarCornerRadius: CGFloat = 2 {
        didSet {
            setNeedsDisplay()
        }
    }
...
struct CustomWaveformViewSwiftUI: UIViewRepresentable {
...
struct CustomRecordingWaveform: UIViewRepresentable {
