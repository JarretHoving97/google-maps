...
enum TextExamples {
    ...
    static let largeMessageText: String =
 """
 freestar
 Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec mi libero, pellentesque in eros id, lacinia tempor ex. Nunc nec eros id mauris blandit vehicula eget at enim. Quisque tincidunt malesuada sapien, quis dapibus mauris sagittis sed. Donec semper fringilla erat at bibendum. Quisque dictum, magna a efficitur vulputate, eros sem finibus est, quis fringilla risus felis id eros.
